...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/Users/crusj/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
  ...
  ["gotests-vim"] = {
    loaded = true,
    path = "/Users/crusj/.local/share/nvim/site/pack/packer/start/gotests-vim",
  ...
  ["vim-cursorword"] = {
    loaded = true,
    path = "/Users/crusj/.local/share/nvim/site/pack/packer/start/vim-cursorword",
    url = "https://github.com/itchyny/vim-cursorword"
  },
  ["vim-delve"] = {
    loaded = true,
    path = "/Users/crusj/.local/share/nvim/site/pack/packer/start/vim-delve",
  ...
  ["vim-rainbow"] = {
    loaded = true,
    path = "/Users/crusj/.local/share/nvim/site/pack/packer/start/vim-rainbow",
